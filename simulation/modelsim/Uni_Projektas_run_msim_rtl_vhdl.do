...
vcom -93 -work work {C:/Users/simon/Desktop/UNI/VHDL/Uni_Projektas/SPI_MASTER.vhd}
...
vcom -93 -work work {C:/Users/simon/Desktop/UNI/VHDL/Uni_Projektas/PacketSend_Testbench.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii -L rtl_work -L work -voptargs="+acc"  PacketSend_Testbench
